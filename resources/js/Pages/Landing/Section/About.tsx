...
export default function About () {
  return (
    <section id="about" className="container mx-auto pt-20 py-5">
      ...
      <p className="text-justify tracking-wide leading-7 mt-3">Hi, my name is Hendrie Ramdhani, i am a Web Developer. I am a student of UIN Syarif Hidayatullah majoring in Informatics Engineering. I love to learn Web Development especially Front-End Web Development. I'm quite mastering in HTML, CSS, Javascript, TailwindCSS, Bootstrap, React, NextJS, and several other technologies. Aside of my hard skills, I'd love to develop my soft skills by being involved in several organizations. With my organization background, I've learned Time Management and Communication Skills to cooperate with any team.</p>
